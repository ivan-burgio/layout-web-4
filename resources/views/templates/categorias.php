<div class="categorias__screen">
    ...
    <div id="modal" class="categorias">
        ...
        <div class="categorias__seccion">
            <div class="categorias__seccion--columna border-end border-1 border-black">
                <a href="/" class="categorias__seccion--link">Novedades</a>
                <a href="/videojuegos" class="categorias__seccion--link">Videojuegos</a>
                <a href="/tecnologia" class="categorias__seccion--link">Tecnologia</a>
                <a href="/entretenimiento" class="categorias__seccion--link">Entretenimiento</a>
                <a href="/anime" class="categorias__seccion--link">Anime</a>
            </div>

            <div class="categorias__seccion--columna">
                <p class="categorias__seccion--link categoria hover">Videojuegos</p>
                <p class="categorias__seccion--link categoria">Anime</p>
            ...
            <div class="categorias__seccion--columna subcategorias flex-row p-0" id="subcategorias-anime">
                <div class="categorias__seccion--columna">
                    <a href="/" class="categorias__seccion--link">Novedades</a>
